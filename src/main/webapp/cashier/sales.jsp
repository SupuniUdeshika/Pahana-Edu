                    ...
                    <div class="col-12">
                        <div class="bg-secondary rounded p-4">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <div>
                                    <form method="GET" action="${pageContext.request.contextPath}/Cashier/sales" class="row g-2">
                                        <div class="col-auto">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#exportBtn').click(function() {
                ...
                window.location.href = '${pageContext.request.contextPath}/Cashier/export-sales?startDate=' + 
