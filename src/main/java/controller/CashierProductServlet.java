...
@WebServlet(name = "CashierProductServlet", urlPatterns = {"/Cashier/products"})
@MultipartConfig(
...
public class CashierProductServlet extends HttpServlet {
    ...
    private void listProducts(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/cashier/products.jsp");
    ...
    private void showNewForm(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/cashier/product-form.jsp");
        dispatcher.forward(request, response);
    }
    ...
    private void insertProduct(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        if (productDAO.addProduct(newProduct)) {
            ...
            request.getRequestDispatcher("/cashier/product-form.jsp").forward(request, response);
        }
    }
